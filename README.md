...
## Note
If you want to use with 25.12, see [openwrt-25.12 branch](https://github.com/nxhack/openwrt-node-packages/tree/openwrt-25.12) (***Current stable series***)
...
| 64bit | full-icu | YES |
 ...
 [Debugging Guide](https://nodejs.org/en/learn/getting-started/debugging) ***Nice to use Chrome DevTools.***
