...
OpenWrt Node.js Packages : for OpenWrt-25.12
...
## Note
If you want to use with 24.10, see [openwrt-24.10 branch](https://github.com/nxhack/openwrt-node-packages/tree/openwrt-24.10) (***Current stable series***)
